...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (m_CharacterController.isGrounded == false && !m_IsWalking)
            {
                PlayBoostSound();
        ...
        private void FixedUpdate()
        {
            ...
            if (m_CharacterController.isGrounded && gravityGun.isHolding == false)
            {
        ...
        {
            if (pause.isPaused == false && end.endScreenIsActive == false)
            {
